...
#     # **Bước 2**: Chuyển sang tab English
#     new_article_type.click_tab_english()
#     time.sleep(1)
...
#     # **Bước 4**: Nhập đường dẫn vào ô 'Article Link' (English)
#     expected_link = "bai-viet-thu-nghiem"
#     enter_field_new_article_type.enter_en_article_link(expected_link)
#     time.sleep(1)

#     # **Bước 5**: Lấy giá trị đã nhập để kiểm tra
...
#     # **Bước 2**: Click vào trường hình ảnh (sử dụng hàm `click_en_meta_image`)
...
#     # **Bước 2**: Nhập 255 ký tự vào ô 'Loại bài viết' (English)
#     long_text = "A" * 255  # Tạo chuỗi 255 ký tự
...
#     # **Bước 1**: Nhập 255 ký tự vào ô 'Liên kết bài viết' (English)
#     long_text = "A" * 255
...
#     # **Bước 1**: Nhập 255 ký tự vào ô 'Mô tả ngắn' (English)
#     long_text = "A" * 255
...
#     # **Bước 1**: Nhập 101 ký tự vào ô 'Meta Keyword' (English)
#     long_text = "A" * 101
...
#     # **Bước 1**: Nhập 501 ký tự vào ô 'Meta Description' (English)
#     long_text = "A" * 501
...
#     # **Bước 1**: Click dropdown 'Status'
#     new_article_type.click_dropdown_status()
#     time.sleep(2)
#     test_logger.info("Đã click vào dropdown 'Status'.")

#     # **Bước 2**: Kiểm tra dropdown có mở không bằng cách tìm chữ 'Chờ xử lý' trên toàn trang
...
#     # **Bước 1**: Click dropdown 'Father Type'
#     new_article_type.click_dropdown_father_type()
#     time.sleep(2)
#     test_logger.info("Đã click vào dropdown 'Father Type'.")

#     # **Bước 2**: Kiểm tra dropdown có mở không bằng cách tìm chữ 'Lĩnh vực kinh doanh' trên toàn trang
...
#     # **Bước 1**: Click dropdown 'Banner Set'
#     new_article_type.click_dropdown_banner_set()
#     time.sleep(2)
#     test_logger.info("Đã click vào dropdown 'Banner Set'.")

#     # **Bước 2**: Kiểm tra dropdown có mở không bằng cách tìm chữ 'Banner icon' trên toàn trang
...
#     # **Bước 1**: Nhập loại bài viết vào ô tiếng Việt
#     expected_text = "Bài viết thử nghiệm"
#     enter_field_new_article_type.enter_vi_article_type(expected_text)
#     time.sleep(1)
...
#     # **Bước 3**: Kiểm tra đường dẫn có chứa loại bài viết vừa nhập
#     expected_url = "https://mpire-cms-demo.mpire.asia/cms/category?page=1"  # Thay thế với URL mong đợi
...
#     # **Bước 4**: Kiểm tra xem loại bài viết có hiển thị trên trang hay không
...
#     # **Bước 2**: Nhấn nút 'Lưu và Tiếp tục'
#     new_article_type.click_save_and_continue_button()
#     time.sleep(2)
#     test_logger.info("Đã nhấn nút 'Lưu và Tiếp tục'.")

#     # **Bước 3**: Kiểm tra trang có chứa thông tin "Chỉnh sửa"
...
def test_enter_content_and_upload_image(new_article_type, enter_field_new_article_type, get_field_new_article_type, meta_image_new_article_type, is_displayed_new_article_type):
    ...
    # **Bước 2**: Nhập dữ liệu vào các ô trong tab 'Tiếng Việt'
    expected_text = "Bài viết thử nghiệm"
    enter_field_new_article_type.enter_vi_article_type(expected_text)
    ...
    # **Step 2**: Enter data into the fields in the 'English' tab
    ...
    # **Step 3**: Verify the entered data
    ...
    # **Step 5**: Verify if the upload popup appears
    assert is_displayed_new_article_type.is_popup_upload_image_displayed(), "Image upload popup did not appear!"
    
    # **Step 6**: Click the "Browser" tab
    meta_image_new_article_type.click_tab_browser()
    time.sleep(1)
    
    # **Step 7**: Select the first image and upload
    meta_image_new_article_type.click_first_image()
    time.sleep(1)
    meta_image_new_article_type.click_button_upload()
    time.sleep(2)  # Wait for the image to upload
    
    # **Step 8**: Verify if the image is displayed
