...
def test_click_save_and_continue_button_after_field_all_information(new_location_base, get_field_new_location, enter_new_location, image_new_location, is_displayed_new_location):
    ...
    expected_sort_value = get_field_new_location.get_sort_order()
    status = "Kích hoạt"
    ...
    if url:
        ...
        test_logger.error(f"Test Case 25 FAIL: test_click_save_and_continue_button_after_field_all_information | Expected: {expected_result} | Actual: {actual_result} | Status: FAIL")
        assert False, f"Expected: {expected_result} | Actual: {actual_result}"                          