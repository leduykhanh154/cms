...
# Test Case 1: Verify khi click menu 'Tất cả bài viết' -> Hệ thống chuyển hướng đến trang 'Danh sách bài viết'. 
def test_navigate_to_all_articles(article):
    test_logger.info("Bắt đầu Test Case 1: Verify khi click menu 'Tất cả bài viết' -> Hệ thống chuyển hướng đến trang 'Danh sách bài viết'.")
    article.click_content_menu()
    article.click_article_menu()
    expected_result = "Hệ thống chuyển hướng đến trang Danh sách bài viết."
    result = article.click_all_article_menu()
    actual_result = expected_result if result else "Hệ thống không chuyển hướng đến trang Danh sách bài viết."
    if result:
...
# Test Case 2: Verify khi click nút 'Tạo mới' -> Hệ thống chuyển hướng đến trang Tạo mới bài viết.
def test_navigate_to_create_article(article):
    test_logger.info("Bắt đầu Test Case 2: Verify khi click nút 'Tạo mới' -> Hệ thống chuyển hướng đến trang 'Tạo mới bài viết'.")
    article.click_content_menu()
    article.click_article_menu()
    article.click_all_article_menu()
    expected_result = "Hệ thống chuyển hướng đến trang Tạo mới bài viết."
    result = article.click_create_new_button()
    actual_result = expected_result if result else "Hệ thống không chuyển hướng đến trang Tạo mới bài viết."
    if result:
...
# Test Case 17: Verify khi chọn 'Loại bài viết' từ dropdown -> Hệ thống ẩn đi thông báo lỗi.
def test_select_article_type_from_dropdown(article, select):
    test_logger.info("Bắt đầu Test Case 17: Verify khi chọn 'Loại bài viết' từ dropdown -> Hệ thống ẩn đi thông báo lỗi.")
    article.perform_tag_operations()
    article.click_create_new_button()
    article.click_save_and_continue_button()
    article.click_tab_general_info()
...
# Test Case 25: Verify khi nhập chữ -> Hệ thống không chấp nhận.
def test_ordering_specific(article, enter_field, validation):
    test_logger.info("Bắt đầu Test Case 25: Verify khi nhập chữ -> Hệ thống không chấp nhận ký tự chữ")
    article.perform_tag_operations()
    article.click_create_new_button()
    article.click_tab_general_info()
    ...
    actual_result = expected_result if not result else "Thông báo lỗi bị ẩn"
    if result:
        test_logger.info(f"Test Case 25 PASS: test_ordering_specific | Expected: {expected_result} | Actual: {actual_result} | Status: PASS")
        assert True
    else:
        test_logger.error(f"Test Case 25 FAIL: test_ordering_specific | Expected: {expected_result} | Actual: {actual_result} | Status: FAIL")
        assert False, f"Expected: {expected_result} | Actual: {actual_result}"

# Test Case 26: Verify khi nhập số âm -> Hệ thống chấp nhận số âm và không hiển thị thông báo lỗi.
def test_ordering_negative_number(article, enter_field, validation):
    test_logger.info("Bắt đầu Test Case 26: Verify khi nhập số âm -> Hệ thống chấp nhận số âm và không hiển thị thông báo lỗi.")
    article.perform_tag_operations()
    article.click_create_new_button()
    article.click_tab_general_info()
    ...
    if result:
        test_logger.info(f"Test Case 26 PASS: test_ordering_negative_number | Expected: {expected_result} | Actual: {actual_result} | Status: PASS")
        assert True
    else:
        test_logger.error(f"Test Case 26 FAIL: test_ordering_negative_number | Expected: {expected_result} | Actual: {actual_result} | Status: FAIL")
        assert False, f"Expected: {expected_result} | Actual: {actual_result}"

# Test Case 27: Verify khi click vào Ngày đăng -> Hệ thống hiển thị đúng ngày hiện tại.
def test_public_date_default_value(article, date):
    test_logger.info("Bắt đầu Test Case 27: Verify khi click vào Ngày đăng -> Hệ thống hiển thị đúng ngày hiện tại.")
    article.perform_tag_operations()
    article.click_create_new_button()
    article.click_tab_general_info()
    article.wait.until(EC.visibility_of_element_located(article.locators.PUBLIC_DATE)).click()
    ...
    if displayed_date == expected_date:
        ...
        test_logger.info(f"Test Case 27 PASS: test_public_date_default_value | Expected: {expected_result} | Actual: {actual_result} | Status: PASS")
        assert True
    else:
        ...
        test_logger.error(f"Test Case 27 FAIL: test_public_date_default_value | Expected: {expected_result} | Actual: {actual_result} | Status: FAIL")
        assert False, f"Expected: {expected_result} | Actual: {actual_result}"

# Test Case 28: Verify khi nhập Ngày đăng -> Hệ thống chấp nhận và hiển thị Ngày đăng.
def test_enter_past_public_date(article, date):
    test_logger.info("Bắt đầu Test Case 28: Verify khi nhập Ngày đăng -> Hệ thống chấp nhận và hiển thị Ngày đăng.")
    article.perform_tag_operations()
    article.click_create_new_button()
    article.click_tab_general_info()
    past_date = (datetime.datetime.now() - datetime.timedelta(days=10)).strftime("%Y-%m-%d")
    ...
    if displayed_date == past_date:
        ...
        test_logger.info(f"Test Case 28 PASS: test_enter_past_public_date | Expected: {expected_result} | Actual: {actual_result} | Status: PASS")
        assert True
    else:
        ...
        test_logger.error(f"Test Case 28 FAIL: test_enter_past_public_date | Expected: {expected_result} | Actual: {actual_result} | Status: FAIL")
        assert False, f"Expected: {expected_result} | Actual: {actual_result}"

# Test Case 29: Verify trạng thái mặc định nút switch Nổi bật -> Hệ thống hiển thị trạng thái mặc định của nút switch Nổi bật là OFF.
def test_featured_switch_initial_state(article, switch):
    test_logger.info("Bắt đầu Test Case 29: Verify trạng thái mặc định nút switch Nổi bật -> Hệ thống hiển thị trạng thái mặc định của nút switch Nổi bật là OFF.")
    article.perform_tag_operations()
    article.click_create_new_button()
    article.click_tab_general_info()
    ...
    if not result:
        test_logger.info(f"Test Case 29 PASS: test_featured_switch_initial_state | Expected: {expected_result} | Actual: {actual_result} | Status: PASS")
        assert True
    else:
        test_logger.error(f"Test Case 29 FAIL: test_featured_switch_initial_state | Expected: {expected_result} | Actual: {actual_result} | Status: FAIL")
        assert False, f"Expected: {expected_result} | Actual: {actual_result}"

# Test Case 30: Verify chuyển trạng thái nút switch Nổi bật từ OFF -> ON. 
def test_toggle_featured_switch_on(article, switch):
    test_logger.info("Bắt đầu Test Case 30: Verify chuyển trạng thái nút switch Nổi bật từ OFF -> ON.")
    article.perform_tag_operations()
    article.click_create_new_button()
    article.click_tab_general_info()
    switch.reset_switch(LocatorArticle.FEATURED_SWITCH, LocatorArticle.FEATURED_LABEL)
    ...
    if result:
        test_logger.info(f"Test Case 30 PASS: test_toggle_featured_switch_on | Expected: {expected_result} | Actual: {actual_result} | Status: PASS")
        assert True
    else:
        test_logger.error(f"Test Case 30 FAIL: test_toggle_featured_switch_on | Expected: {expected_result} | Actual: {actual_result} | Status: FAIL")
        assert False, f"Expected: {expected_result} | Actual: {actual_result}"
...
# Test Case 33: Verify khi click nút Tải lên ở Hình ảnh thumbnail -> Hệ thống hiển thị pop-up Upload hình ảnh
def test_click_thumbnail_image_button(article, image):
    test_logger.info("Bắt đầu Test Case 33: Verify khi click nút Tải lên ở Hình ảnh thumbnail -> Hệ thống hiển thị pop-up Upload hình ảnh")
    article.perform_tag_operations()
    article.click_create_new_button()
    article.click_tab_general_info()
    ...
    actual_result = expected_result if not result else "Pop-up upload hình ảnh hiển thị thành công"
    if result:
        test_logger.info(f"Test Case 33 PASS: test_click_thumbnail_image_button | Expected: {expected_result} | Actual: {actual_result} | Status: PASS")
        assert True
    else:
        test_logger.error(f"Test Case 33 FAIL: test_click_thumbnail_image_button | Expected: {expected_result} | Actual: {actual_result} | Status: FAIL")
        assert False, f"Expected: {expected_result} | Actual: {actual_result}"

# Test Case 34: Verify khi tải lên Hình ảnh Thumbnail -> Hệ thống hiển thị hình ảnh lên field Hình ảnh Thumbnail.
def test_upload_thumbnail_image(article, image):
    test_logger.info("Bắt đầu Test Case 34: Verify khi tải lên Hình ảnh Thumbnail -> Hệ thống hiển thị hình ảnh lên field Hình ảnh Thumbnail.")
    article.perform_tag_operations()
    article.click_create_new_button()
    article.click_tab_general_info()
    image.click_upload_thumbnail_image_field()
    ...
    if result:
        test_logger.info(f"Test Case 34 PASS: test_upload_thumbnail_image | Expected: {expected_result} | Actual: {actual_result} | Status: PASS")
        assert True
    else:
        test_logger.error(f"Test Case 34 FAIL: test_upload_thumbnail_image | Expected: {expected_result} | Actual: {actual_result} | Status: FAIL")
        assert False, f"Expected: {expected_result} | Actual: {actual_result}"

# Test Case 35: Verify khi click nút Xóa ảnh -> Hệ thống xóa ảnh ra khỏi field Hình ảnh Thumbnail
def test_delete_thumbnail_image(article, image):
    test_logger.info("Bắt đầu Test Case 35: Verify khi click nút Xóa ảnh -> Hệ thống xóa ảnh ra khỏi field Hình ảnh Thumbnail")
    article.perform_tag_operations()
    article.click_create_new_button()
    article.click_tab_general_info()
    image.click_upload_thumbnail_image_field()
    ...
    if result:
        test_logger.info(f"Test Case 35 PASS: test_delete_thumbnail_image | Expected: {expected_result} | Actual: {actual_result} | Status: PASS")
        assert True
    else:
        test_logger.error(f"Test Case 35 FAIL: test_delete_thumbnail_image | Expected: {expected_result} | Actual: {actual_result} | Status: FAIL")
        assert False, f"Expected: {expected_result} | Actual: {actual_result}"
