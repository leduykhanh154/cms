...
class ArticleValidation:
    ...
    def is_title_vi_max_length_error_displayed(self):
        return self.is_error_message_displayed(self.locators.TITLE_MAX_LENGTH_ERROR_LOCATOR, "Vui lòng nhập Tiêu đề không quá 250 ký tự")
    ...
    def is_short_description_vi_max_lenght_error_displayed(self):
